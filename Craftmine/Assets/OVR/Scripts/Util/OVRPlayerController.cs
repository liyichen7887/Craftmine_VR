...
public class OVRPlayerController : MonoBehaviour
{
    ...
    {
        if (!m_Jump && CrossPlatformInputManager.GetAxis("Oculus_GearVR_LIndexTrigger") > 0.9f)
        {
            if (can_jump)
            {
                m_Jump = true;
        ...
        if (CrossPlatformInputManager.GetAxis("Oculus_GearVR_LIndexTrigger") < 0.1f)
        {
            can_jump = true;
        }
    ...
    protected virtual void UpdateController()
	{
        ...
        if (CrossPlatformInputManager.GetAxis("Oculus_GearVR_LHandTrigger")>0.9f)
        {
            UpdateMovement();
        }
	...
	public virtual void UpdateMovement()
	{
        ...
        Vector2 primaryAxis = new Vector2(0.0f, 5.0f);
